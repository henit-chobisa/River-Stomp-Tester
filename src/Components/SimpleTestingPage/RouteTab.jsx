...
const RouteTab = (props) => {
    ...
    const renderRoutes = () => {
        if (routes.length === 0) {
            ...
            return routes.map((route, index) => (<RouteItem key={index} route={route.value} index={index} isActive={route.isActive} handleRoutePop={handleRoutePop} handleSelection={handleRouteItemSelection} />));
        }
    }
